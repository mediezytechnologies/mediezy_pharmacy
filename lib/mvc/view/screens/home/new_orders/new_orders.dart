...
class _NewOrderScreenState extends State<NewOrderScreen> with TickerProviderStateMixin {
  TabController? tabController;
  final MedicineController medicineController = Get.put(MedicineController());
  final UpcomingDateController upcomingDateController = Get.put(UpcomingDateController());
  final CompletedController completedController = Get.put(CompletedController());
    ...
    upcomingDateController.getUpcomingDate().then((_) {
      ...
      setState(() {
        tabController = TabController(length: 2, vsync: this);
         ...
         medicineController.getMedicine(upcomingDateController.nestedTabIndex.value);
    });
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                controller: tabController,
                children: [
                  NestedTabBar(tabController: tabController!),
                  CompletedOrdersTab(),
                ],
              ),
            ),
