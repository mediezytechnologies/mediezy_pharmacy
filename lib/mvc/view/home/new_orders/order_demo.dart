                        ...
                        itemBuilder: (context, index) {
                          return Obx(() {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text(medicine.id.toString()),
                              leading: Checkbox(
                                value: checkboxController.checkedItems
                          ...
                          //           .toString()),
                          //     value:checkboxController .checkedItems.contains(index),
                          //       onChanged: (newValue) {
...
//                  List<int> checkedIds = checkboxController.checkedIds;
// print(checkedIds);
//               }, child: Text("data")),
              Card(
                child: Padding(
